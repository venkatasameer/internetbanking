...
?>
<!-- visit freesourcecodes.buzz for more projects! -->
<!DOCTYPE html>
<html lang="en">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <!-- ./Balances-->
          </div><!-- visit freesourcecodes.buzz for more projects! -->
          ...
          <!-- Main row -->
          <div class="row"><!-- visit freesourcecodes.buzz for more projects! -->
            <!-- Left col -->
            <div class="col-md-12">
              <!-- TABLE: Transactions -->
              <div class="card">
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered table-striped m-0">
                      ...
                      <tbody><!-- visit freesourcecodes.buzz for more projects! -->
                        <?php
